...
--
-- Host: 127.0.0.1    Database: fitness_site
-- ------------------------------------------------------
...
CREATE TABLE `appointment` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`ID`)
...
CREATE TABLE `orders` (
  ...
  `status` enum('in progress','sent','delivered') NOT NULL DEFAULT 'in progress',
...
-- Dump completed on 2025-04-02 12:37:46
